...
```bash
git remote add origin https://github.com/davitalbert1/emulator.git
```
...
```bash
git remote set-url origin git@github.com:davitalbert1/emulator.git

ou

git remote set-url github git@github.com:davitalbert1/emulator.git
```
...
```text
origin  git@github.com:davitalbert1/emulator.git (fetch)
origin  git@github.com:davitalbert1/emulator.git (push)
```
